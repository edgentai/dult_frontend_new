...
// const userAction =  () => {
//   const response =  fetch('https://jw1so5sptg.execute-api.us-east-1.amazonaws.com/beta', {
//     method: 'POST',
...
//   // return response
// }
// // const api_data = userAction();
// // console.log(api_data)
// userAction().then((data) => { abc(data) })
